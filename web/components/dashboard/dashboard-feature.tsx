  ...
  return (
    <div>
      ...
      <div className="max-w-xxl mx-auto py-6 sm:px-6 lg:px-8 text-left">
        ...
        {/* <button className="btn btn-sm btn-primary">Create Token</button>
        <button className="btn btn-sm btn-ghost">Create Ghost</button> */}
        <hr />
        <p>&nbsp;</p>
        ...
        <button
          ...
          onClick={ async() => {
            ...
            setFlag(flag+1);  console.log("flag  ", flag);
            ...
            try {
              ...
              console.error('Error during creation of token account:', err);
            }
